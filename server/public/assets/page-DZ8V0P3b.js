const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-BxoHy5gx.js","assets/index-Ct-ulYoa.js","assets/statsSession-RS9odABG.js"])))=>i.map(i=>d[i]);
import{T as d,O as c,R as m,_ as h,i as b}from"./index-Ct-ulYoa.js";import{o as u}from"./statsSession-RS9odABG.js";class v{constructor(){this.rankings=[],this.mySessionId="",this.spawnerInterval=null,this.tooltip=null}start(t){if(document.title="Leaderboard | Zigma",d.ensureClosed(),this.createTooltip(),c.requirePortrait(),this.room=t==null?void 0:t.room,this.rankings=(t==null?void 0:t.leaderboardData)||[],this.rankings.sort((e,i)=>e.rank-i.rank),this.mySessionId=(t==null?void 0:t.mySessionId)||(this.room?this.room.sessionId:""),this.container=document.createElement("div"),this.container.id="leaderboard-ui",this.container.style.cssText="position:absolute; top:0; left:0; width:100%; height:100%; z-index:1000;",document.body.appendChild(this.container),!document.getElementById("leaderboard-styles")){const e=document.createElement("style");e.id="leaderboard-styles",e.innerHTML=this.getGlobalStyles(),document.head.appendChild(e)}this.renderLeaderboard(),this.room&&this.room.onMessage("gameEnded",e=>{this.rankings=e.rankings,this.rankings.sort((i,a)=>i.rank-a.rank),this.renderLeaderboard()}),setTimeout(()=>d.open(),100)}getGlobalStyles(){return`
            #leaderboard-ui {
